          ...
          <div class="no-wrap q-pa-md filters text-body2">
            <div class="column">
              ...
              <!-- <div class="q-mb-md">
                ...
                <div>
                  <q-chip
                    v-model:selected="productSize.XS"
                    color="accent"
                    text-color="black"
                  >
                    XS
                  ...
                  <q-chip
                    v-model:selected="productSize.S"
                    color="accent"
                    text-color="black"
                  >
                    S
                  ...
                  <q-chip
                    v-model:selected="productSize.M"
                    color="accent"
                    text-color="black"
                  >
                    M
                  ...
                  <q-chip
                    v-model:selected="productSize.L"
                    color="accent"
                    text-color="black"
                  >
                    L
                  ...
                  <q-chip
                    v-model:selected="productSize.XL"
                    color="accent"
                    text-color="black"
                  >
                    XL
                  ...
                  <q-chip
                    v-model:selected="productSize.XXL"
                    color="accent"
                    text-color="black"
                  >
                    XXL
              ...
              <div class="q-mb-md">
                <span class="text-weight-medium">Colour:</span>
                <div>
                  <q-chip
                    v-model:selected="productColour.black"
                    color="black"
                    text-color="white"
                  >
                  </q-chip>
                  <q-chip
                    v-model:selected="productColour.white"
                    color="black"
                    text-color="black"
                    outline
                  >
                  ...
                  <q-chip
                    v-model:selected="productColour.red"
                    color="red"
                    text-color="white"
                  >
                  </q-chip>
                  <q-chip
                    v-model:selected="productColour.green"
                    color="green"
                    text-color="white"
                  >
                  </q-chip>
                  <q-chip
                    v-model:selected="productColour.yellow"
                    color="yellow"
                    text-color="white"
                  >
                  </q-chip>
                  <q-chip
                    v-model:selected="productColour.purple"
                    color="purple"
                    text-color="white"
                  >
                  </q-chip>
                  <q-chip
                    v-model:selected="productColour.blue"
                    color="blue"
                    text-color="white"
                  >
                  </q-chip>
