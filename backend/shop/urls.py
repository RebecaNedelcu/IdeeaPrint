from .views import FavoriteViewset, OrderViewset, ProductDetailsViewset, ProductViewset, get_favorite, get_product_details, get_products_by_type, illustrations_by_product_type, product_illustration_details, send_contact_message, toggle_favorite
