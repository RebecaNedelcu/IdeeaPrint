from .views import FavoriteViewset, ProductDetailsViewset, ProductViewset, get_favorite, illustrations_by_product_type, product_illustration_details, send_contact_message, toggle_favorite
